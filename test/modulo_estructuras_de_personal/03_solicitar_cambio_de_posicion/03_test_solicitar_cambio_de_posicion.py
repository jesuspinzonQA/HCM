...
def test_solicitar_cambio_posicion(estructuras_personal, nombre_posicion):

    seleccionar_solicitar_cambio_posicion(estructuras_personal)
    buscar_posicion(estructuras_personal, nombre_posicion)
    seleccionar_posicion(estructuras_personal, nombre_posicion)
